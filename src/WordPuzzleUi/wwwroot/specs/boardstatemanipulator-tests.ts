...
describe("When shuntToRight()", function () {
    ...
    testCases([
        ["W   ", 0, " W  ", "    "], // Start with 3 Blanks
        [" A  ", 1, "  A ", " A  "],
        ["  N ", 2, "   N", "    "],
        ["SA  ", 1, "S A ", " A  "], // Start with 2 Blanks
        ["WA  ", 0, " WA ", " A  "],
        ["W A ", 0, " WA ", " A  "],
        ["S N ", 2, "S  N", "    "],
        ["W  N", 0, " W N", "    "],
        ...
        [" WN ", 2, " W N", "    "],
        [" A N", 1, "  AN", " A  "],
        ["WAN ", 0, " WAN", " A  "], // Start with 1 Blank
        ["SAN ", 1, "S AN", " A  "],
        ["SWN ", 2, "SW N", "    "],
        ["WA N", 0, " WAN", " A  "],
        ["WA N", 1, "W AN", " A  "],
...
describe("When shuntToLeft()", function () {
    ...
    testCases([
        ...
        [' SA ', 1, "S A ", " A  "],
        ['S W ', 2, "SW  ", "    "],
        [' SWA', 3, "SWA ", " A  "], // Start with 1 Blank
        [' SWN', 2, "SW N", "    "],
        [' SAN', 1, "S AN", " A  "],
        ['SW A', 3, "SWA ", " A  "],
        ['S WA', 3, "SWA ", " A  "],
...
describe("When shuntToLeft()", function () {
    ...
    testCases([
        ...
        it("given the Letters '" + letters + "' and target Tile " + targetTileIndex + " lettersShunted events are published", function () {
            ...
            var observer = { callback: function (sourceTileId: number, destinationTileId: number) { } };
            spyOn(observer, "callback").and.callThrough();
